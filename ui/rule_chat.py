...
from core.llm_engine import get_chat_response
...
def render_rule_builder():
    ...
    if st.button("📝 현재 룰 조율 완료 및 시뮬레이터로 전송", type="primary"):
        with st.spinner("최종 게임 규칙을 매뉴얼로 정리하는 중입니다..."):
            ...
            final_rules = get_chat_response(temp_context)
